...
public class CustomBatchPlugin extends PluginAdapter {
    ...
    public boolean clientInsertMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        Method batchInsertMethod = copyProperties(method, "batchInsert",listParameterType);
...
//        addBatchUpdateSelectiveElements(parentElement, introspectedTable);
    ...
    private Method copyProperties(Method source, String name,FullyQualifiedJavaType listParameterType) {
        Method method = new Method(name);
        method.setReturnType(source.getReturnType());
        ...
        addParameter(method,listParameterType);
        return method;
    }

    private void addParameter(Method method,FullyQualifiedJavaType listParameterType) {
        method.getParameters().clear();
        method.addParameter(new Parameter(listParameterType, "list"));
    }
